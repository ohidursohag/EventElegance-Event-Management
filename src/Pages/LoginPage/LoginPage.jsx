            ...
            <div className="relative  w-[350px] sm:w-[450px]  rounded-3xl bg-orange-500">
               <div className=" py-16 px-5 sm:px-10 flex  w-full flex-col rounded-3xl bg-slate-200 bg-opacity-20 shadow">
                  ...
                  <div className="flex flex-col justify-center items-center gap-3 ">
                     <div
                        onClick={handleGoogleSignIn} className="cursor-pointer group border-white group  mt-5 inline-flex h-12 w-[310px] sm:w-[350px] items-center justify-center gap-2  rounded-3xl border px-4 py-2 transition-colors duration-300  hover:bg-[#34A353] hover:border-[#34A353] focus:outline-none">
                        <span>
                     ...
                     <div onClick={handleGithubLogin}
                        href="#" className="cursor-pointer border-white-500 group inline-flex h-12 w-[310px] sm:w-[350px] items-center justify-center gap-2  rounded-3xl border px-4 py-2 transition-colors duration-300 hover:border-black hover:bg-black focus:outline-none">
                        <span>
