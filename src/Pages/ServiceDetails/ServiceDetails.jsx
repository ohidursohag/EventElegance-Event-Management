...
return(
   <div className={`min-h-screen`}>
      <div style={{ backgroundImage: `url(${selectedService?.image})`}} className={`h-screen bg-no-repeat bg-cover bg-center bg-black/40 bg-blend-overlay flex justify-center items-center`}>
         <div className=" py-16 px-5  mx-auto bg-gray-700/40 backdrop-blur-[2px] flex flex-col justify-center gap-2 items-center rounded-lg ">
      ...
      <Container className={``}>
         <div className="my-10">
            ...
            <div className="flex flex-col lg:flex-row gap-5">
               <figure className=" rounded-lg overflow-auto max-h-[700px] lg:w-[40%]">
                  <img className="object-cover h-full w-full" src={selectedService?.thumbnailImage} />
               </figure>
               <div className="text-gray-500  flex flex-col  lg:w-[60%]">
